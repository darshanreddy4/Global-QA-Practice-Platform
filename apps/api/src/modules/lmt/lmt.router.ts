...
const LMT_DICTIONARY: Record<string, Record<LangCode, string>> = {
  ...
  CHECKOUT_BTN: { en: "Checkout", hi: "चेकआउट करें", ta: "செக்அவுட்", te: "చెక్అవుట్", kn: "ಚೆಕ್‌ಔಟ್", ml: "ചെക്ക്ഔട്ട്", bn: "চেকআউট", mr: "चेकआउट करा" },
  REMOVE_BTN: { en: "Remove", hi: "हटाएं", ta: "அகற்று", te: "తీసివేయి", kn: "ತೆಗೆದುಹಾಕಿ", ml: "നീക്കം ചെയ്യുക", bn: "সরান", mr: "काढा" },
  ORDER_PLACED_MSG: { en: "Order placed successfully!", hi: "ऑर्डर सफलतापूर्वक दिया गया!", ta: "ஆர்டர் வெற்றிகரமாக வைக்கப்பட்டது!", te: "ఆర్డర్ విజయవంతంగా ఇవ్వబడింది!", kn: "ಆರ್ಡರ್ ಯಶಸ್ವಿಯಾಗಿ ನೀಡಲಾಗಿದೆ!", ml: "ഓർഡർ വിജയകരമായി നൽകി!", bn: "অর্ডার সফলভাবে প্রদান করা হয়েছে!", mr: "ऑर्डर यशस्वीरित्या दिली!" },
  ACCOUNT_CREATED_MSG: { en: "Account created successfully!", hi: "खाता सफलतापूर्वक बनाया गया!", ta: "கணக்கு வெற்றிகரமாக உருவாக்கப்பட்டது!", te: "ఖాతా విజయవంతంగా సృష్టించబడింది!", kn: "ಖಾತೆ ಯಶಸ್ವಿಯಾಗಿ ರಚಿಸಲಾಗಿದೆ!", ml: "അക്കൗണ്ട് വിജയകരമായി സൃഷ്ടിച്ചു!", bn: "অ্যাকাউন্ট সফলভাবে তৈরি করা হয়েছে!", mr: "खाते यशस्वीरित्या तयार केले!" },
  CART_EMPTY_MSG: { en: "Your cart is empty", hi: "आपका कार्ट खाली है", ta: "உங்கள் கார்ட் காலியாக உள்ளது", te: "మీ కార్ట్ ఖాళీగా ఉంది", kn: "ನಿಮ್ಮ ಕಾರ್ಟ್ ಖಾಲಿಯಾಗಿದೆ", ml: "നിങ്ങളുടെ കാർട്ട് ശൂന്യമാണ്", bn: "আপনার কার্ট খালি", mr: "तुमची कार्ट रिकामी आहे" },
  FIELD_REQUIRED_MSG: { en: "All fields are required.", hi: "सभी फ़ील्ड आवश्यक हैं।", ta: "அனைத்து புலங்களும் அவசியம்.", te: "అన్ని ఫీల్డ్‌లు అవసరం.", kn: "ಎಲ್ಲಾ ಕ್ಷೇತ್ರಗಳು ಅಗತ್ಯವಿದೆ.", ml: "എല്ലാ ഫീൽഡുകളും ആവശ്യമാണ്.", bn: "সমস্ত ক্ষেত্র আবশ্যক।", mr: "सर्व फील्ड आवश्यक आहेत." },
};
